...
//     send_LoRa_data(set_port, String(sensorValue1));
//     send_LoRa_data(set_port, String(sensorValue2));
//     // blinky();
//     delay(1000);
...
// void send_LoRa_data_alt(int tx_port, String rawdata)
// {
//     send_LoRa_Command(String(tx_port, rawdata))
// }
// void blinky()
// {
